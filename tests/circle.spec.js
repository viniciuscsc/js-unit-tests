...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    let objetoRaioTres = circle(3);
    objetoRaioTres.area = parseFloat(objetoRaioTres.area.toFixed(2));
    expect(objetoRaioTres).toStrictEqual({radius: 3, area: 28.26, circumference: 18.84});
  });
});
